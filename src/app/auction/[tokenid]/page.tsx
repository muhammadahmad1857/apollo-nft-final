...
export default function AuctionPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-10 space-y-8">
     ...
     { auction.endTime <= new Date()&&<BidInput isDisabled={(auction.seller.walletAddress === address)||auction.settled || auction.endTime < new Date()} onPlaceBid={handlePlaceBid} minBid={auction.highestBid || auction.minBid} />}
