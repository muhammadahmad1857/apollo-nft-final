              ...
              <CardHeader className="p-0 min-h-56 relative dark:bg-gray-900 bg-gray-100">
                {auction.nft.imageUrl ? (
                  <Image
                    ...
                    className="min-h-56 w-full object-contain rounded-t-lg"
                    fill
                  />
                ) : (
                  <div className="absolute inset-0 flex items-center justify-center text-zinc-400">
                   <UniversalMediaIcon tokenUri={auction.nft.tokenUri || ""} uri={auction.nft.mediaUrl || ""} fileType={auction.nft.fileType} className="w-16 h-16" />
                  </div>
                )}
              </CardHeader>
<Separator />
